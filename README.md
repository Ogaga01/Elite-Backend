...
# 📖 [Elite Travelers Backend] <a name="about-project"></a>
...
- [Frontend Repo](https://github.com/Ogaga01/Elite-Traveler-Frontend)
...
```
git@github.com:Ogaga01/Elite-Backend.git
```
...
```sh
  cd my-folder
  git clone git@github.com:Ogaga01/Elite-Backend.git
```
...
- [ ] **[Properly Calculate Price with Number Of Days]**
